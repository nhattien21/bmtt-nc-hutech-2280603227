...
# Add a transaction for the miner (Genesis block)
my_blockchain.add_transaction('Genesis', 'Miner', 1)

# Create a new block with the new proof
...
for block in my_blockchain.chain:
    ...
    print("Previous Hash:", block.previous_hash)  # corrected 'block previous_hash' to 'block.previous_hash'
